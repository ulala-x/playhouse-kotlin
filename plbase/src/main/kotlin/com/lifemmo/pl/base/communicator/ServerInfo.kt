...
import com.lifemmo.pl.base.Plbase.ServerInfoMsg
...
class ServerInfo private constructor(val bindEndpoint: String,
    ...
    companion object{
        ...
        fun of(infoMsg: ServerInfoMsg):ServerInfo{
            return ServerInfo(
                infoMsg.endpoint,
    ...
    fun toMsg(): ServerInfoMsg {
        return ServerInfoMsg.newBuilder().setServiceType(this.serviceType.name)
