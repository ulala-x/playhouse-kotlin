...
import com.lifemmo.pl.base.service.room.*
import com.lifemmo.pl.base.service.room.base.command.*
...
class BaseRoom(
    ...
    private suspend fun dispatch(routePacket: RoutePacket) {
        ...
        try{
            ...
            roomSender.errorReply(routePacket.routeHeader, BaseErrorCode.SYSTEM_ERROR)
                ...
                if(item!=null) {
                    launch (baseRoomCoroutineContext) {
                        try {
                            ...
                            roomSender.errorReply(routePacket.routeHeader, BaseErrorCode.UNCHECKED_CONTENTS_ERROR)
                            log.error(ExceptionUtils.getStackTrace(e))
                        }
                    }
                }else{
