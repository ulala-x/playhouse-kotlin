...
//    public static final int XREP = ROUTER;
    ...
    /**
     * EVENT_DISCONNECTED: broken baseSession.
     * The EVENT_DISCONNECTED event triggers when the stream engine (tcp and
     * ipc specific) detects a corrupted / broken baseSession. Value is the FD of
     * the socket.
     */
...
//        }
    ...
    public static class Socket implements Closeable {
         ...
         * 
         * @param optVal The value of 'ZMQ_TCP_KEEPALIVE_INTVL' defines the interval between keepalives. PacketGroup is OS
         *            dependant.
         */
         ...
         *            over the socket and the first keepalive probe. PacketGroup is OS dependant.
         */
         ...
         * instance, leaving the rest in spot and functional.
         * 
         * @param topic
         */
        ...
        public void setRouterHandOver(boolean isHandOver) {
            if (ZMQ.version_full() >= ZMQ.make_version(4, 1, 0)) {
                setLongSockopt(ROUTER_HAND_OVER, isHandOver ? 1L : 0L);
            }
        }
        ...
        private static final int ROUTER_HAND_OVER = 56;
