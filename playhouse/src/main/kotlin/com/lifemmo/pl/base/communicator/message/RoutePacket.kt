...
import com.lifemmo.pl.base.Plbase.RoomTimer
import com.lifemmo.pl.base.Plcommon.HeaderMsg
import com.lifemmo.pl.base.protocol.*
...
class RouteHeader private constructor(val header: Header,
    ...
    var from: String = ""
    fun toMsg(): Plbase.RouteHeaderMsg {
        return Plbase.RouteHeaderMsg.newBuilder()
    ...
    companion object {
        fun of(headerMsg: Plbase.RouteHeaderMsg): RouteHeader {
...
//            .setMessage(message).build()
    ...
    companion object {
        ...
        fun of(routePacketMsg: Plbase.RoutePacketMsg):RoutePacket{
...
//        }
        ...
        fun addTimerOf(
            ...
            val header = Header(Plbase.TimerMsg.getDescriptor().name)
            val routeHeader = RouteHeader.of(header).apply {
                this.roomId = roomId
                this.isBase = true
            }

            val message = Plbase.TimerMsg.newBuilder().setType(type).setCount(count)
...
class AsyncBlockPacket<T> private constructor(
    ...
    companion object {
        fun<T> of(
            ...
            val header = Header(Plbase.AsyncBlock.getDescriptor().name)
            val routeHeader = RouteHeader.of(header)
