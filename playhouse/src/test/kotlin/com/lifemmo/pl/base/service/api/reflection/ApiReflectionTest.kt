package com.lifemmo.pl.base.service.api.reflection

import com.lifemmo.pl.base.PlTest.*
import com.lifemmo.pl.base.Plbase.RouteHeaderMsg
...
import com.lifemmo.pl.base.service.api.*
...
internal class ApiReflectionTest {
    ...
    @Configuration @ComponentScan("com.lifemmo.pl.base.service.api.reflection") open class TestConfigure
    ...
    fun apiHandlerMethodCall(){
        ...
        val routePacketMsg = RoutePacketMsg.newBuilder()
            .setRouteHeaderMsg(RouteHeaderMsg.newBuilder().setSessionInfo("").setHeaderMsg(Plcommon.HeaderMsg.newBuilder().setMsgName("ApiTestMsg1")))
    ...
    fun apiBackendMethodCall(){
        ...
        val routePacketMsg = RoutePacketMsg.newBuilder()
            .setRouteHeaderMsg(RouteHeaderMsg.newBuilder().setSessionInfo("")
                .setHeaderMsg(Plcommon.HeaderMsg.newBuilder().setMsgName("ApiTestMsg2")).setIsBackend(true))
            .setMessage(ApiTestMsg1.newBuilder().setTestMsg("reflection").build().toByteString())
            .build()
