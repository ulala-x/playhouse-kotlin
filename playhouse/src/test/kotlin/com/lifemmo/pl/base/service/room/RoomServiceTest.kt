...
import com.lifemmo.pl.base.Plbase.CreateJoinRoomRes
...
//        }
    ...
    private fun createRoomPacket(roomType: String): RoutePacket {
        val packet = Packet(
            Plbase.CreateRoomReq.newBuilder()
    ...
    fun create_room_with_success(): Long {
        ...
        val createRoomRes = Plbase.CreateRoomRes.parseFrom(resultList[0].buffer())
    ...
    fun create_room_with_invalid_type(){
        ...
        Thread.sleep(100)
        assertThat(resultList.size).isEqualTo(1)
        assertThat(resultList[0].routeHeader.header.baseErrorCode).isEqualTo(BaseErrorCode.ROOM_TYPE_IS_INVALID)
    }
    ...
    fun join_room_test_with_success(){
        ...
        assertThat(Plbase.JoinRoomRes.parseFrom(resultList[2].buffer()).payloadName).isEqualTo("contentJoinRoom")
    }
    ...
    fun join_room_test_with_invalid_roomId(){
        ...
        Thread.sleep(100)
        assertThat(resultList.size).isEqualTo(1)
        assertThat(resultList[0].routeHeader.header.baseErrorCode).isEqualTo(BaseErrorCode.ROOM_IS_NOT_EXIST)
    }
